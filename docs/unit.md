...
The Karma unit test boilerplate comes with [inject-loader](https://github.com/plasticine/inject-loader) installed by default. For usage with `*.kdu` components, see [kdu-loader docs on testing with mocks](http://kdujs-loader.web.app/en/workflow/testing-with-mocks.html).
